...
public class GoodsDao
{
    ...
    public List<Title> getScrollGood() throws SQLException {
        final QueryRunner r = new QueryRunner(DBUtil.getDataSource());
        final String sql = "select g.id,g.name,g.cover,g.price,g.intro from recommend r,goods g where type=1 and r.goods_id=g.id";
        return (List<Title>)r.query(sql, (ResultSetHandler)new BeanListHandler<>(Title.class));
    }
